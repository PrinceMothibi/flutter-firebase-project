...
class _SettingsViewState extends State<SettingsView> {
  ...
  void initState() {
    ...
    FuelPriceModel fuelPriceModel =
        Provider.of<FuelPriceModel>(context, listen: false);
          ...
          builder: (context, fuelPriceModel, child) {
            ...
            return Column(
              ...
              children: <Widget>[
                ...
                DieselPriceSetter(dieselTextController: _dieselTextController)
              ],
            );
          },
        ));
...
class DieselPriceSetter extends StatelessWidget {
  const DieselPriceSetter({
    super.key,
    required TextEditingController dieselTextController,
  }) : _dieselTextController = dieselTextController;

  final TextEditingController _dieselTextController;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextField(
        ...
        keyboardType: TextInputType.number,
        decoration:
            const InputDecoration(labelText: 'Diesel', suffixText: "R/litre"),
      ),
    );
  }
}
